...
class hobrgpdsystemHelper {


    //Facebook Cookies
    public static function hob_ac_facebook_service_address() {
        $input ="facebook.com 
facebook.de 
facebook.fr 
facebook.net 
...
facebookofsex.com 
fbcdn.net";
        return $cookie_array = explode("\n",$input);
    }
    //Google Analytics Cookies
    public static function hob_ac_google_analytics_service_address() {
        $input ="google-analytics.com
        googletagmanager.com";
        return $cookie_array = explode("\n",$input);
    }
    //Google Analytics Cookies
    public static function hob_ac_google_ads_service_address() {
        $input ="developers.google.com 
                gmail.com 
                adwords.google.com 
                mail.google.com 
                inbox.google.com 
...
gstatic.com";
    ...
    //Google Maps Cookies
    public static function hob_ac_google_maps_service_address() {
        $input ="maps.google.com
        maps";
        return $cookie_array = explode("\n",$input);
    }
    public static function hob_ac_calameo_service_address() {
        $input ="calameo.com";
        return $cookie_array = explode("\n",$input);
    }
    public static function hob_ac_recaptcha_service_address() {
        $input ="recaptcha-anchor 
        rc-anchor
        recaptcha-token
        recaptcha
        recaptcha.com
    ...
    public static function hob_ac_mailchimp_service_address() {
        $input ="mailchimp.com";
        return $cookie_array = explode("\n",$input);
    }
    public static function hob_ac_twitter_service_address() {
        $input ="tweetdeck.com 
        twimg.com 
        twitter.com  
        twitter.co 
    ...
    public static function hob_ac_google_plus_service_address() {
        $input ="plus.google.com 
                plusone.google.com ";
        return $cookie_array = explode("\n",$input);
    }
    public static function hob_ac_linkedin_service_address() {
        $input ="linkedin.com";
        return $cookie_array = explode("\n",$input);
    }
    public static function hob_ac_pinterest_service_address() {
        $input ="pinterest.com ";
        return $cookie_array = explode("\n",$input);
    }
    public static function hob_ac_instagram_service_address() {
        $input ="instantservice.com 
instagram.com ";
        return $cookie_array = explode("\n",$input);
    }
    public static function hob_ac_youtube_service_address() {
        $input ="youtube.com 
        ytimg.com
        yimg.com 
        youtu.be";
    ...
    public static function hob_ac_vimeo_service_address() {
        $input ="vimeo.com 
vimeocdn.com ";
        return $cookie_array = explode("\n",$input);
    }
    public static function hob_ac_dailymotion_service_address() {
        $input ="dailymotion.com";
        return $cookie_array = explode("\n",$input);
    }
    //Every Other Services .
    public static function hob_ac_other_service_address() {
        $input ="atlassolutions.com 
friendfeed.com 
2mdn.net 
admeld.com 
admob.com 
